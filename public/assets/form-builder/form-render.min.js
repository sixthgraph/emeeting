    ...
    var o = "function" == typeof Symbol && "symbol" == typeof Symbol.iterator ? function(t) {
        ...
        a = function() {
            ...
            return t.prototype.configure = function() {}, t.prototype.build = function(t, e, n) {
                ...
                })),n[0] = n[0].replace("<br>",""), this.isTemplate("label") ? this.processTemplate("label", n) : this.markup("label", n, {
                    for: this.data.id,
            ...
            function t() {
                ...
                var r = {
                    ...
                    notify: {
                        ...
                        success: function(t) {
                            var checkTiny = $('div[type="tinymce"]').length;
                            //if(checkTiny > 0){
                                alert('aaa')
                                // $.getScript( "//cdn.tiny.cloud/1/2yf9vawzd690121ileh5xiao9bsifshwfki5klu0upro7n16/tinymce/6/tinymce.min.js", function( data, textStatus, jqxhr ) {
                                //     console.log('load tinymnc success')
                                // });
                                   
                            //}
                            $( 'div[type="tinymce"]' ).each(function( index ) {
                                console.log( index + ": " + $( this ).attr('id') );
                                var eid =  $( this ).attr('id')
                                $(this).append('<textarea id="'+eid+'-editor" class="tiny"></textarea>');
                                tinymce.init({
                                    selector: 'textarea#'+eid+'-editor',
                            ...
                            return dOMEvalFormula(!0), console.log(t)// Form Rendered
                        },
                        warning: function(t) {
                            return console.warn(t)
                        }
